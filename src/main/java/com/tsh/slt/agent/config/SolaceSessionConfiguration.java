package com.tsh.slt.agent.config;

import com.solacesystems.jcsmp.*;
import com.tsh.slt.agent.util.SuaCommonUtil;
...
public class SolaceSessionConfiguration {
	...
	public JCSMPProperties getProperty(String postfixClientName){
		...
		String clientName = SuaCommonUtil.generateClientName(groupName, siteName, envType, processSeq);
