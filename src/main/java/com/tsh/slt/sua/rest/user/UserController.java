package com.tsh.slt.sua.rest.user;

import com.tsh.slt.sua.domain.user.vo.dto.UserMasterDataDTO;
import com.tsh.slt.sua.domain.user.service.SltrLcUserService;
